<div align="center">
  ...
  <h1>create-neex</h1>
  <h3>CLI for creating Neex projects</h3>

<a href="https://www.npmjs.com/package/create-neex"><img alt="NPM version" src="https://img.shields.io/npm/v/create-neex.svg?style=for-the-badge&labelColor=000000&color=0066FF&borderRadius=8"></a>
<a href="https://www.npmjs.com/package/create-neex"><img alt="Download Count" src="https://img.shields.io/npm/dt/create-neex.svg?style=for-the-badge&labelColor=000000&color=0066FF&borderRadius=8"></a>
<a href="https://github.com/Neexjs/create-neex/blob/main/LICENSE"><img alt="MIT License" src="https://img.shields.io/badge/license-MIT-0066FF.svg?style=for-the-badge&labelColor=000000&borderRadius=8"></a>
<a href="https://github.com/Neexjs"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-Neex-0066FF.svg?style=for-the-badge&logo=github&labelColor=000000&logoWidth=20&borderRadius=8"></a>
...
2. **Enter your project name** (e.g., `my-awesome-project`) or use `.` for current directory.

3. **Select your package manager** (if not specified via flags):
   - npm
   - yarn
   - pnpm
   - bun
...
### `neex init` / `create-neex`

```bash
# Create in current directory
npx create-neex@latest .

# or with package manager flags
npx create-neex@latest my-project --npm
npx create-neex@latest my-project --pnpm
npx create-neex@latest my-project --yarn
npx create-neex@latest my-project --bun
...
# Create in current directory with package manager
npx create-neex@latest . --bun

# Enable debug mode
npx create-neex@latest my-project --debug

# Combine flags
npx create-neex@latest my-project --pnpm --debug
```
...
### Remote Cache with Cloudflare R2

Configure distributed caching for faster builds across your team.

```bash
# Setup R2 credentials
npx create-neex cache --r2

# Check cache status
npx create-neex cache --status

# Clear configuration
npx create-neex cache --clear
```

### Benefits
- **Free tier**: 10GB storage on Cloudflare R2
- **Fast**: Cache hits restore in ~300ms
- **Team-wide**: Share build artifacts across developers
- **CI/CD**: Speed up deployment pipelines

### Setup Guide
1. Create Cloudflare R2 bucket
2. Generate API credentials
3. Run `npx create-neex cache --r2`
4. Enter credentials when prompted
5. Builds now use remote cache automatically
